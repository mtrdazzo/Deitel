 ...
 * 
 * Enhance class DollarAmount from Exercise 10.12 to make the overloaded addition, subtraction, and multiplication
...
/**
 * @brief Multiplication operator for int * DollarAmount
 * 
 * @param lhs integer
 * @param rhs DollarAmount class
 * @return DollarAmount 
 */
inline DollarAmount operator*(const int lhs, const DollarAmount & rhs) {
    return DollarAmount(lhs) * rhs;
}

/**
 * @brief Subtraction operator for int - DollarAmount
 * 
 * @param lhs integer
 * @param rhs DollarAmount class
 * @return DollarAmount 
...
/**
 * @brief Addition operator for int + DollarAmount
 * 
 * @param lhs integer
 * @param rhs DollarAmount class
 * @return DollarAmount 
...
/**
 * @brief Division operator for int / DollarAmount
 * 
 * @param lhs integer
 * @param rhs DollarAmount class
 * @return DollarAmount 
 */
inline int64_t operator/(const int64_t lhs, const DollarAmount & rhs) {
    return DollarAmount(lhs) / rhs;
}