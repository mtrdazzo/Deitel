/**
 * @file tst_Ex_10_9.cpp
 * @author Matthew J Randazzo (mtrdazzo@gmail.com)
 * @brief Test HugeInteger class functionality
 * @version 0.1
 * @date 2020-07-03
 * 
...
/**
 * @brief Division operator overloaded with Intgers
 * 
 */
TEST(Division, Integers) {
    ...
    int digit1{23};
    HugeInteger doubleDigit1{digit1};
    HugeInteger doubleDigit2 = doubleDigit1 * 2;
    ...
    /* Inverse property with HugeInteger */
    HugeInteger doubleDigit3 = doubleDigit2 / digit1;
    EXPECT_EQ(doubleDigit3, HugeInteger(2));

    /* Divide double digit HugeInteger by itself */
    doubleDigit2 = doubleDigit1 / digit1;
    EXPECT_EQ(doubleDigit2, one);
    ...
    /* Double digit with remainder */
    EXPECT_EQ(doubleDigit1 / (digit1 - 1), HugeInteger(1));

    /* Divide double digit by smaller double digit */
    EXPECT_EQ(doubleDigit1 / (digit1 + 1), zero);
