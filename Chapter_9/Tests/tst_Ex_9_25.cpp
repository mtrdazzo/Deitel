...
/**
 * @brief Verifies there is a flush of diamonds in the hand.
 */
...
/**
 * @brief Verifies there is a flush of spades in the hand.
 */
TEST(Flush, flushSpades) {
...
/**
 * @brief Verifies there is a royal flush of hearts in the hand.
 */
TEST(RoyalFlush, flushHearts) {

    PlayerHand samplePlayer;

    samplePlayer.acceptCard(new Card(Card::eHEARTS, Card::e10));
    samplePlayer.acceptCard(new Card(Card::eHEARTS, Card::eAce));
    samplePlayer.acceptCard(new Card(Card::eHEARTS, Card::eKing));
    samplePlayer.acceptCard(new Card(Card::eHEARTS, Card::eQueen));
    samplePlayer.acceptCard(new Card(Card::eHEARTS, Card::eJack));
...
/**
 * @brief Verifies there is a royal flush of clubs in the hand.
 */
TEST(RoyalFlush, flushClubs) {
...
TEST(Deal, noPair) {
    ...
    std::cout << "The Winner is Player " << (int) game.determineWinner() << '\n' << std::endl;
